...
import { a as stripHtml } from "./string-DcW5i2yt.mjs";
import { t as M } from "../_libs/ts-pattern.mjs";
import { g as sanitizeCss, p as pageDimensionsAsPixels } from "./client-BWxMxJtI.mjs";
import { n as AlertDescription, r as AlertTitle, t as Alert } from "./alert-CTJXrILL.mjs";
import { $ as e, Hn as o$1, Ln as r$1, Rt as e$1, dt as a, r, tn as o } from "../_libs/phosphor-icons__react.mjs";
import { d as useResumeStore, l as TiptapContent } from "./resume-ChldmFWM.mjs";
import { c as webfontlist_default, i as getSectionTitle, n as PageIcon, s as useCSSVariables, t as LevelDisplay } from "./section-C5EoZxrX.mjs";
import { a as useResizeObserver, i as useIsMounted } from "../_libs/usehooks-ts.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/preview-spne3rtR.js
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(!hasRoles || item.position) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-start justify-between gap-x-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					hasRoles && !item.position && item.period && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			hasRoles && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "experience-item-roles mt-0 flex flex-col gap-y-1",
				children: item.roles.map((role) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "experience-item-role",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-start justify-between gap-x-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "section-item-metadata experience-item-role-position",
							children: role.position
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "section-item-metadata experience-item-role-period shrink-0 text-end",
							children: role.period
						})]
					}), stripHtml(role.description) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "section-item-description experience-item-role-description mt-0.5",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TiptapContent, { content: role.description })
					})]
				}, role.id))
			}),
			!hasRoles && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function PageSummary({ className }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: cn("page-section page-section-summary", className),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h6", {
			className: "mb-1.5 text-(--page-primary-color)",
...
function getSectionComponent(section, { sectionClassName, itemClassName } = {}) {
	return M(section).with("summary", () => {
		const SummarySection = (_) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSummary, { className: sectionClassName });
		return SummarySection;
	}).with("profiles", () => {
		const ProfilesSection = (_) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
			type: "profiles",
		...
		const ExperienceSection = (_) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
			type: "experience",
			className: sectionClassName,
		...
		const EducationSection = (_) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
			type: "education",
			className: sectionClassName,
		...
		const ProjectsSection = (_) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
			type: "projects",
			className: sectionClassName,
		...
		const SkillsSection = (_) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
			type: "skills",
			className: sectionClassName,
		...
		const LanguagesSection = (_) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
			type: "languages",
			className: sectionClassName,
		...
		const InterestsSection = (_) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
			type: "interests",
			className: sectionClassName,
		...
		const AwardsSection = (_) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
			type: "awards",
			className: sectionClassName,
		...
		const CertificationsSection = (_) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
			type: "certifications",
			className: sectionClassName,
		...
		const PublicationsSection = (_) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
			type: "publications",
			className: sectionClassName,
		...
		const VolunteerSection = (_) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
			type: "volunteer",
			className: sectionClassName,
		...
		const ReferencesSection = (_) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
			type: "references",
			className: sectionClassName,
		...
		const CustomSectionComponent = ({ id }) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [customSection.type !== "cover-letter" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h6", {
					className: "mb-1.5 text-(--page-primary-color)",
...
function ChikoritaTemplate({ pageIndex, pageLayout }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [!fullWidth && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "page-sidebar-background pointer-events-none absolute inset-y-0 z-0 w-(--page-sidebar-width) shrink-0 bg-(--page-primary-color) ltr:inset-e-0 rtl:inset-s-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex",
...
function DitgarTemplate({ pageIndex, pageLayout }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [(!fullWidth || isFirstPage) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "page-sidebar-background pointer-events-none absolute inset-y-0 z-0 w-(--page-sidebar-width) shrink-0 bg-(--page-primary-color)/20 ltr:inset-s-0 rtl:inset-e-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "basics-header",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "basics-name font-bold text-2xl",
					children: basics.name
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "basics-headline",
					children: basics.headline
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "basics-items flex flex-col items-start gap-y-2 text-sm [&>div>i]:text-(--page-background-color)!",
				children: [
					basics.location && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "basics-item-location flex items-center gap-x-1.5",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageIcon, {
							icon: "map-pin",
							className: "ph-bold"
					...
					basics.phone && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "basics-item-phone flex items-center gap-x-1.5",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageIcon, {
							icon: "phone",
							className: "ph-bold"
					...
					basics.email && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "basics-item-email flex items-center gap-x-1.5",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageIcon, {
							icon: "at",
							className: "ph-bold"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageLink, {
					...
					basics.website.url && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "basics-item-website flex items-center gap-x-1.5",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageIcon, {
							icon: "globe",
							className: "ph-bold"
					...
					basics.customFields.map((field) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "basics-item-custom flex items-center gap-x-1.5",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageIcon, { icon: field.icon }), field.link ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageLink, {
							url: field.link,
							label: field.text
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: field.text })]
...
function getTemplateComponent(template) {
	return M(template).with("azurill", () => AzurillTemplate).with("bronzor", () => BronzorTemplate).with("chikorita", () => ChikoritaTemplate).with("custompro", () => CustomproTemplate).with("ditto", () => DittoTemplate).with("ditgar", () => DitgarTemplate).with("gengar", () => GengarTemplate).with("glalie", () => GlalieTemplate).with("kakuna", () => KakunaTemplate).with("lapras", () => LaprasTemplate).with("leafish", () => LeafishTemplate).with("onyx", () => OnyxTemplate).with("pikachu", () => PikachuTemplate).with("rhyhorn", () => RhyhornTemplate).exhaustive();
}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			showPageNumbers && totalNumberOfPages > 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "absolute inset-s-0 -top-6 print:hidden",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			metadata.page.format !== "free-form" && pageHeight > maxPageHeight && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "absolute inset-s-0 top-full mt-4 print:hidden",
