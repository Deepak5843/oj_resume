...
import { At as useRender, Ct as DialogClose, Mt as mergeProps, Nt as require_jsx_runtime, St as DialogDescription, bt as DialogPortal, rt as DialogRoot, wt as DialogBackdrop, xt as DialogPopup, yt as DialogTitle } from "../_libs/@base-ui/react+[...].mjs";
...
import { i as TooltipTrigger, n as TooltipContent, t as Tooltip$1 } from "./tooltip-BVeYmHHi.mjs";
import { t as Separator$1 } from "./separator-CXxNwIYE.mjs";
import { n as useIsMobile } from "./skeleton-DSmksJ4N.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/sidebar-CUvoHeZG.js
...
function SheetOverlay({ className, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogBackdrop, {
		...
		className: cn("data-open:fade-in-0 data-closed:fade-out-0 fixed inset-0 z-50 bg-black/10 duration-100 data-closed:animate-out data-open:animate-in data-ending-style:opacity-0 data-starting-style:opacity-0 supports-backdrop-filter:backdrop-blur-xs", className),
		...props
	});
}
...
var sidebarMenuButtonVariants = cva("peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-active:bg-sidebar-accent data-active:font-medium data-active:text-sidebar-accent-foreground data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&_svg]:size-4 [&_svg]:shrink-0", {
	variants: {
		variant: {
...
function SidebarMenuButton({ isActive = false, variant = "default", size = "default", tooltip, className, render, ...props }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tooltip$1, { children: [children, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipContent, {
		side: "right",
		align: "center",
...
//#endregion
export { SidebarGroupContent as a, SidebarMenu as c, SidebarProvider as d, SidebarRail as f, SidebarGroup as i, SidebarMenuButton as l, SidebarTrigger as m, SidebarContent as n, SidebarGroupLabel as o, SidebarSeparator as p, SidebarFooter as r, SidebarHeader as s, Sidebar as t, SidebarMenuItem as u };
