...
import { Ct as DialogClose, Nt as require_jsx_runtime, St as DialogDescription, Tt as AlertDialogRoot, bt as DialogPortal, wt as DialogBackdrop, xt as DialogPopup, yt as DialogTitle } from "../_libs/@base-ui/react+[...].mjs";
import { t as Button$1 } from "./button-C8loFr-r.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/alert-dialog-D7HiPloB.js
...
function AlertDialogTitle({ className, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, {
		...
		className: cn("font-medium text-lg sm:group-data-[size=default]/alert-dialog-content:group-has-data-[slot=alert-dialog-media]/alert-dialog-content:col-start-2", className),
		...props
	});
}
