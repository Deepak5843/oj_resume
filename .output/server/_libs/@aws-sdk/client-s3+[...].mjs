...
var METADATA_SYMBOL$1, XmlNode$1;
...
var init_node2json = __esmMin((() => {
	init_xmlNode();
	METADATA_SYMBOL = XmlNode$1.getMetaDataSymbol();
}));
//#endregion
...
var init_fxp = __esmMin((() => {
	init_validator();
	init_XMLParser();
	XMLValidator = { validate: validate$1 };
}));
//#endregion
...
var init_node_http2_connection_manager = __esmMin((() => {
	...
	NodeHttp2ConnectionManager = class {
		...
		lease(requestContext, connectionConfiguration) {
			...
			const session = nodeHTTP2.connect(url);
...
var dist_es_exports$23 = /* @__PURE__ */ __exportAll({ parseUrl: () => parseUrl });
var parseUrl;
...
var require_endpoints = /* @__PURE__ */ __commonJSMin(((exports) => {
	var urlParser = (init_dist_es$28(), __toCommonJS(dist_es_exports$23));
...
var require_schema = /* @__PURE__ */ __commonJSMin(((exports) => {
	var protocolHttp = (init_dist_es$41(), __toCommonJS(dist_es_exports$29));
	var utilMiddleware = (init_dist_es$40(), __toCommonJS(dist_es_exports$28));
...
var dist_es_exports$22 = /* @__PURE__ */ __exportAll({ v4: () => v4 });
...
var require_serde = /* @__PURE__ */ __commonJSMin(((exports) => {
	var uuid = (init_dist_es$27(), __toCommonJS(dist_es_exports$22));
...
var require_protocols$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var utilStream = (init_dist_es$30(), __toCommonJS(dist_es_exports$24));
	var schema = require_schema();
	var serde = require_serde();
	var protocolHttp = (init_dist_es$41(), __toCommonJS(dist_es_exports$29));
	var utilBase64 = (init_dist_es$36(), __toCommonJS(dist_es_exports$26));
	var utilUtf8 = (init_dist_es$37(), __toCommonJS(dist_es_exports$27));
	...
	var HttpProtocol = class extends SerdeContext {
		...
		async loadEventStreamCapability() {
			const { EventStreamSerde } = await import("../_21.mjs").then((m) => /* @__PURE__ */ __toESM(m.default));
...
var require_dist_cjs$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var types = (init_dist_es$42(), __toCommonJS(dist_es_exports$30));
	var utilMiddleware = (init_dist_es$40(), __toCommonJS(dist_es_exports$28));
	var protocolHttp = (init_dist_es$41(), __toCommonJS(dist_es_exports$29));
...
var dist_es_exports$20 = /* @__PURE__ */ __exportAll({
...
var dist_es_exports$19 = /* @__PURE__ */ __exportAll({ calculateBodyLength: () => calculateBodyLength$1 });
...
var require_cbor = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var protocols = require_protocols$1();
	var protocolHttp = (init_dist_es$41(), __toCommonJS(dist_es_exports$29));
	var utilBodyLengthBrowser = (init_dist_es$24(), __toCommonJS(dist_es_exports$19));
	var schema = require_schema();
	var utilMiddleware = (init_dist_es$40(), __toCommonJS(dist_es_exports$28));
	var utilBase64 = (init_dist_es$36(), __toCommonJS(dist_es_exports$26));
	var majorUint64 = 0;
	...
	var buildHttpRpcRequest = async (context, headers, path, resolvedHostname, body) => {
		...
		if (endpoint.headers) for (const [name, value] of Object.entries(endpoint.headers)) contents.headers[name] = value;
		if (body !== void 0) {
			contents.body = body;
			try {
...
var init_dist_es$22 = __esmMin((() => {
	...
	init_ser_utils();
	init_serde_json();
	__reExport(dist_es_exports$18, /* @__PURE__ */ __toESM(require_serde()));
}));
//#endregion
...
//#endregion
//#region node_modules/@aws-sdk/core/dist-cjs/index.js
var require_dist_cjs = /* @__PURE__ */ __commonJSMin(((exports) => {
	var protocolHttp = (init_dist_es$41(), __toCommonJS(dist_es_exports$29));
	var core = require_dist_cjs$1();
	var propertyProvider = (init_dist_es$26(), __toCommonJS(dist_es_exports$21));
	var client = require_client();
	var signatureV4 = (init_dist_es$25(), __toCommonJS(dist_es_exports$20));
	var cbor = require_cbor();
	var schema = require_schema();
	var smithyClient = (init_dist_es$22(), __toCommonJS(dist_es_exports$18));
	var protocols = require_protocols$1();
	var serde = require_serde();
	var utilBase64 = (init_dist_es$36(), __toCommonJS(dist_es_exports$26));
	var utilUtf8 = (init_dist_es$37(), __toCommonJS(dist_es_exports$27));
	var xmlBuilder = (init_dist_es$21(), __toCommonJS(dist_es_exports$17));
	var state = { warningEmitted: false };
	var emitWarningIfUnsupportedVersion = (version) => {
		if (version && !state.warningEmitted && parseInt(version.substring(1, version.indexOf("."))) < 20) {
			state.warningEmitted = true;
	...
	return (next, context) => async (args) => {
		...
		if (HttpResponse.isInstance(response)) {
			if (response.headers.expires) {
				...
				try {
					(0, dist_es_exports$18.parseRfc7231DateTime)(response.headers.expires);
				} catch (e) {
...
//#endregion
//#region node_modules/@aws-sdk/middleware-sdk-s3/dist-es/s3-express/constants.js
init_dist_es$17();
	...
	if (typeof config.retryStrategy === "function") {
		...
		if (typeof retryStrategy.mode === "string") switch (retryStrategy.mode) {
			case RETRY_MODES.ADAPTIVE:
				(0, import_dist_cjs$1.setFeature)(context, "RETRY_MODE_ADAPTIVE", "F");
				break;
			case RETRY_MODES.STANDARD:
				(0, import_dist_cjs$1.setFeature)(context, "RETRY_MODE_STANDARD", "E");
				break;
		}
	}
...
var init_getHomeDir = __esmMin((() => {
	...
	getHomeDir = () => {
		...
		if (!homeDirCache[homeDirCacheKey]) homeDirCache[homeDirCacheKey] = homedir$1();
...
var dist_es_exports$7 = /* @__PURE__ */ __exportAll({ loadConfig: () => loadConfig });
...
//#endregion
//#region node_modules/@smithy/middleware-retry/dist-es/defaultRetryQuota.js
...
//#endregion
//#region node_modules/@smithy/middleware-retry/dist-es/delayDecider.js
...
//#endregion
//#region node_modules/@smithy/middleware-retry/dist-es/retryDecider.js
...
//#endregion
//#region node_modules/@smithy/middleware-retry/dist-es/StandardRetryStrategy.js
...
//#endregion
//#region node_modules/@smithy/middleware-retry/dist-es/AdaptiveRetryStrategy.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/endpoint/ruleset.js
...
var devDependencies = {
	"@aws-sdk/signature-v4-crt": "3.1011.0",
...
var typesVersions = { "<4.5": { "dist-types/*": ["dist-types/ts3.4/*"] } };
var files = ["dist-*/**"];
var author = {
...
var remoteProvider = async (init) => {
	const { ENV_CMDS_FULL_URI, ENV_CMDS_RELATIVE_URI, fromContainerMetadata, fromInstanceMetadata } = await import("../_22.mjs");
	if (process.env[ENV_CMDS_RELATIVE_URI] || process.env[ENV_CMDS_FULL_URI]) {
		init.logger?.debug("@aws-sdk/credential-provider-node - remoteProvider::fromHttp/fromContainerMetadata");
		const { fromHttp } = await import("../_8.mjs");
...
`);
	...
	async (awsIdentityProperties) => {
		...
		const { fromSSO } = await import("../_11.mjs");
		return fromSSO(init)(awsIdentityProperties);
	},
	async (awsIdentityProperties) => {
		init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromIni");
		const { fromIni } = await import("../_9.mjs");
		return fromIni(init)(awsIdentityProperties);
	},
	async (awsIdentityProperties) => {
		init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromProcess");
		const { fromProcess } = await import("../_10.mjs");
		return fromProcess(init)(awsIdentityProperties);
	},
	async (awsIdentityProperties) => {
		init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromTokenFile");
		const { fromTokenFile } = await import("../_13.mjs");
...
var init_getTypeScriptUserAgentPair = __esmMin((() => {
	...
	getTypeScriptUserAgentPair = async () => {
		...
		for (const nodeModulesParentDir of nodeModulesParentDirs) try {
			const packageJson = await readFile(join$1(nodeModulesParentDir, "package.json"), "utf-8");
		...
		for (const nodeModulesParentDir of nodeModulesParentDirs) try {
			const packageJson = await readFile(join$1(nodeModulesParentDir, TS_PACKAGE_JSON), "utf-8");
...
var init_resolveDefaultsModeConfig = __esmMin((() => {
	...
	inferPhysicalRegion = async () => {
		...
		if (!process.env["AWS_EC2_METADATA_DISABLED"]) try {
			const { getInstanceMetadataEndpoint, httpRequest } = await import("../_22.mjs");
...
//#endregion
export { dist_es_exports$15 as $, loadConfig as A, HttpRequest as At, init_dist_es$10 as B, fromEnv as C, init_dist_es$36 as Ct, init_dist_es$6 as D, init_dist_es$40 as Dt, dist_es_exports$6 as E, dist_es_exports$28 as Et, readFile$2 as F, dist_es_exports$11 as G, init_dist_es$11 as H, getSSOTokenFromFile as I, init_dist_es$15 as J, init_dist_es$13 as K, getSSOTokenFilepath as L, externalDataInterceptor as M, init_fxp as Mt, parseKnownFiles as N, XMLParser as Nt, dist_es_exports$7 as O, dist_es_exports$29 as Ot, loadSsoSessionData as P, init_dist_es$18 as Q, getProfileName as R, ENV_SESSION as S, dist_es_exports$26 as St, init_dist_es$5 as T, init_dist_es$37 as Tt, dist_es_exports$10 as U, dist_es_exports$9 as V, init_dist_es$12 as W, init_dist_es$16 as X, dist_es_exports$13 as Y, dist_es_exports$14 as Z, ENV_ACCOUNT_ID as _, init_dist_es$30 as _t, S3Client as a, init_dist_es$22 as at, ENV_KEY as b, init_dist_es$33 as bt, require_protocols as c, chain as ct, dist_es_exports$2 as d, ProviderError as dt, init_dist_es$19 as et, init_dist_es$2 as f, require_dist_cjs$1 as ft, init_dist_es$4 as g, parseUrl as gt, dist_es_exports$4 as h, init_dist_es$28 as ht, DeleteObjectCommand as i, dist_es_exports$18 as it, init_dist_es$9 as j, XMLValidator as jt, init_dist_es$8 as k, init_dist_es$41 as kt, dist_es_exports$1 as l, TokenProviderError as lt, init_dist_es$3 as m, dist_es_exports$23 as mt, ListObjectsV2Command as n, init_dist_es$20 as nt, dist_es_exports as o, require_client as ot, dist_es_exports$3 as p, require_schema as pt, dist_es_exports$12 as q, GetObjectCommand as r, require_dist_cjs as rt, init_dist_es as s, init_dist_es$26 as st, PutObjectCommand as t, dist_es_exports$16 as tt, init_dist_es$1 as u, CredentialsProviderError as ut, ENV_CREDENTIAL_SCOPE as v, sdkStreamMixin as vt, dist_es_exports$5 as w, dist_es_exports$27 as wt, ENV_SECRET as x, NodeHttpHandler as xt, ENV_EXPIRATION as y, dist_es_exports$25 as yt, dist_es_exports$8 as z };
