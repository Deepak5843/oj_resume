...
import { M as externalDataInterceptor, j as init_dist_es$1, ot as require_client, st as init_dist_es, ut as CredentialsProviderError } from "./client-s3+[...].mjs";
...
var fromWebToken = (init) => async (awsIdentityProperties) => {
	...
	if (!roleAssumerWithWebIdentity) {
		const { getDefaultRoleAssumerWithWebIdentity } = await import("../_16.mjs").then((m) => /* @__PURE__ */ __toESM(m.default));
