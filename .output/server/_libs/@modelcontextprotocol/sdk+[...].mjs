...
import { Bn as array, Ca as $ZodType, Da as safeParse$1, Ea as parseAsync, Fa as defineLazy, Fi as datetime, Ia as normalizeParams, In as _null, Kr as record, Lr as number, Nn as _enum, Oa as safeParseAsync$1, Pa as clone, Ri as toJSONSchema, Rr as object$1, Sa as $ZodObject, Ta as parse, Tr as looseObject, Ur as preprocess, Wn as boolean, X as objectType, Xr as string, Y as ZodFirstPartyTypeKind, Zn as custom, ci as union, er as discriminatedUnion, gr as intersection, li as unknown, on as ZodOptional, wr as literal, za as $constructor, zr as optional } from "../@ai-sdk/anthropic+[...].mjs";
...
*
*/
var IconsSchema = object$1({ icons: array(object$1({
	src: string(),
...
*/
var ToolExecutionSchema = object$1({ taskSupport: _enum([
	"required",
	"optional",
	"forbidden"
]).optional() });
...
*/
var ToolChoiceSchema = object$1({ mode: _enum([
	"auto",
	"required",
	"none"
]).optional() });
...
//#endregion
//#region node_modules/@modelcontextprotocol/sdk/dist/esm/shared/uriTemplate.js
