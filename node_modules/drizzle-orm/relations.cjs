	...
	for (const [target, value] of entries) {
		...
		switch (target) {
			...
			default: {
				...
				const filter = require_sql_expressions_conditions.and(relationFilter, typeof value === "boolean" ? void 0 : relationsFilterToSQL(targetTable, value, targetConfig.relations, tablesRelations, casing, depth + 1));
