...
declare function getValueFromDataApi(field: Field): string | number | boolean | Uint8Array<ArrayBufferLike> | string[] | number[] | boolean[] | _aws_sdk_client_rds_data0.ArrayValue[] | null;
