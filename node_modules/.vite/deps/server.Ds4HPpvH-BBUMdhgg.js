import { A as runWithSpan, I as toArray, O as resolveMaybeOptionalOptions, R as value, c as asyncIteratorWithSpan, g as isAsyncIteratorObject, h as intercept, w as overlayProxy } from "./dist-D6AwnVLs.js";
import { p as ORPCError, r as HibernationEventIterator } from "./dist-Cr8nxtrC.js";
import { t as mapEventIterator } from "./client.BLtwTQUg-DfwNBSJl.js";
import { d as ValidationError, f as isContractProcedure, m as validateORPCError, p as mergeErrorMap, s as mergePrefix, t as enhanceRoute } from "./dist-XIz-cOri.js";
...
async function unlazyRouter(router) {
	if (isProcedure(router)) return router;
	const unlazied = {};
...
//#endregion
export { traverseContractProcedures as C, setHiddenRouterContract as S, unlazyRouter as T, lazy as _, createAccessibleLazyRouter as a, middlewareOutputFn as b, createORPCErrorConstructorMap as c, getHiddenRouterContract as d, getLazyMeta as f, isStartWithMiddlewares as g, isProcedure as h, call as i, createProcedureClient as l, isLazy as m, Procedure as n, createAssertedLazyProcedure as o, getRouter as p, addMiddleware as r, createContractedProcedure as s, LAZY_SYMBOL as t, enhanceRouter as u, mergeCurrentContext as v, unlazy as w, resolveContractProcedures as x, mergeMiddlewares as y };

//# sourceMappingURL=server.Ds4HPpvH-BBUMdhgg.js.map