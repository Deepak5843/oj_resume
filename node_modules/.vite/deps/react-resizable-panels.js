...
function nn({ debounceSaveMs: e = 100, panelIds: t, storage: n = localStorage, ...o }) {
	const i = t !== void 0, s = "id" in o ? o.id : o.groupId, l = me(s, t ?? []), r = (0, import_react.useSyncExternalStore)(Kt, () => n.getItem(l), () => n.getItem(l)), a = (0, import_react.useMemo)(() => r ? JSON.parse(r) : void 0, [r]), u = (0, import_react.useRef)(null), c = (0, import_react.useCallback)(() => {
		const v = u.current;
	...
	const m = (0, import_react.useCallback)((v) => {
		c();
		let x;
	...
	return {
		defaultLayout: a,
		onLayoutChange: (0, import_react.useCallback)((v) => {
...
//#endregion
export { Ut as Group, qt as Panel, Zt as Separator, Pt as isCoarsePointer, nn as useDefaultLayout, on as useGroupCallbackRef, rn as useGroupRef, sn as usePanelCallbackRef, an as usePanelRef };
