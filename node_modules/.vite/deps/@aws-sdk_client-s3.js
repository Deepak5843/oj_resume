import "./chunk-olfrzTEO.js";
import { n as fromUtf8$3, t as toUtf8 } from "./toUtf8.browser-BKcViWCA.js";
import { n as __awaiter, o as __values, r as __generator, s as init_tslib_es6 } from "./tslib.es6-ChdOd-NW.js";
...
var DEFAULT_CHECKSUM_ALGORITHM = ChecksumAlgorithm$1.CRC32;
//#endregion
...
var defaultErrorHandler$1 = (signingProperties) => (error) => {
	throw error;
};
var defaultSuccessHandler$1 = (httpResponse, signingProperties) => {};
...
var toUint8Array = (data) => {
	if (typeof data === "string") return fromUtf8$3(data);
...
function toBase64(_input) {
	let input;
	if (typeof _input === "string") input = fromUtf8$3(_input);
	else input = _input;
...
var isReadableStream$1 = (stream) => typeof ReadableStream === "function" && (stream?.constructor?.name === ReadableStream.name || stream instanceof ReadableStream);
//#endregion
...
var keepAliveSupport = { supported: void 0 };
var FetchHttpHandler = class FetchHttpHandler {
	...
	async handle(request, { abortSignal, requestTimeout: requestTimeout$1 } = {}) {
		...
		const raceOfPromises = [fetch(fetchRequest).then((response) => {
			...
			if (!(response.body != void 0)) return response.blob().then((body) => ({ response: new HttpResponse({
...
var collectBody$1 = async (streamBody = new Uint8Array(), context) => {
...
var HttpProtocol = class extends SerdeContext {
	...
	async loadEventStreamCapability() {
		const { EventStreamSerde } = await import("./event-streams-DYaLIBg3.js");
...
var UUID_PATTERN$1 = /^[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}$/;
...
var hasHeader$1 = (soughtHeader, headers) => {
...
var XmlShapeSerializer = class extends SerdeContextConfig {
	...
	writeSimple(_schema, value) {
		...
		if (ns.isStringSchema()) if (value === void 0 && ns.isIdempotencyToken()) nodeContents = v4();
...
var getChecksumLocationName = (algorithm) => algorithm === ChecksumAlgorithm$1.MD5 ? "content-md5" : `x-amz-checksum-${algorithm.toLowerCase()}`;
//#endregion
...
var fromUtf8$2 = (input) => new TextEncoder().encode(input);
//#endregion
...
//#endregion
//#region node_modules/@aws-crypto/crc32c/build/module/aws_crc32c.js
init_tslib_es6();
...
//#endregion
//#region node_modules/@aws-crypto/crc32c/build/module/index.js
init_tslib_es6();
var Crc32c = function() {
	function Crc32c() {
...
var lookupTable$1 = uint32ArrayFrom([
	0,
	4067132163,
	3778769143,
	324072436,
...
//#endregion
//#region node_modules/@aws-sdk/middleware-flexible-checksums/dist-es/getCrc32ChecksumAlgorithmFunction.browser.js
...
var selectChecksumAlgorithmFunction = (checksumAlgorithm, config) => {
	...
	switch (checksumAlgorithm) {
		case ChecksumAlgorithm$1.MD5: return checksumAlgorithms?.MD5 ?? config.md5;
		case ChecksumAlgorithm$1.CRC32: return checksumAlgorithms?.CRC32 ?? getCrc32ChecksumAlgorithmFunction();
		case ChecksumAlgorithm$1.CRC32C: return checksumAlgorithms?.CRC32C ?? AwsCrc32c;
		...
		case ChecksumAlgorithm$1.SHA1: return checksumAlgorithms?.SHA1 ?? config.sha1;
		case ChecksumAlgorithm$1.SHA256: return checksumAlgorithms?.SHA256 ?? config.sha256;
		default:
...
var getEndpointPlugin = (config, instructions) => ({ applyToStack: (clientStack) => {
...
var getRetryPlugin = (options) => ({ applyToStack: (clientStack) => {
...
//#endregion
//#region node_modules/@aws-crypto/sha1-browser/node_modules/@smithy/util-utf8/dist-es/fromUtf8.browser.js
...
//#endregion
//#region node_modules/@aws-crypto/sha1-browser/build/module/constants.js
...
//#endregion
//#region node_modules/@aws-crypto/sha1-browser/build/module/webCryptoSha1.js
var Sha1$1 = function() {
...
function supportsSecureRandom(window) {
	if (typeof window === "object" && typeof window.crypto === "object") return typeof window.crypto.getRandomValues === "function";
	return false;
}
...
//#endregion
//#region node_modules/@aws-crypto/sha1-browser/build/module/crossPlatformSha1.js
var Sha1 = function() {
	function Sha1(secret) {
		if (supportsWebCrypto(locateWindow())) this.hash = new Sha1$1(secret);
...
//#endregion
//#region node_modules/@smithy/eventstream-serde-browser/dist-es/utils.js
...
//#endregion
//#region node_modules/@smithy/eventstream-serde-browser/dist-es/EventStreamMarshaller.js
...
//#endregion
//#region node_modules/@smithy/eventstream-serde-browser/dist-es/provider.js
...
//#endregion
//#region node_modules/@smithy/hash-blob-browser/dist-es/index.js
...
//#endregion
//#region node_modules/@smithy/md5-js/dist-es/constants.js
var INIT = [
	1732584193,
	4023233417,
	2562383102,
...
//#endregion
//#region node_modules/@smithy/md5-js/dist-es/index.js
var Md5 = class {
	state;
	buffer;
	bufferLength;
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/runtimeConfig.browser.js
var getRuntimeConfig = (config) => {
	...
	return {
		...
		useDualstackEndpoint: config?.useDualstackEndpoint ?? (() => Promise.resolve(false)),
		useFipsEndpoint: config?.useFipsEndpoint ?? (() => Promise.resolve(false))
	};
};
//#endregion
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/AbortMultipartUploadCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/CompleteMultipartUploadCommand.js
...
var getLocationConstraintPlugin = (config) => ({ applyToStack: (clientStack) => {
	clientStack.add(locationConstraintMiddleware(config), locationConstraintMiddlewareOptions);
} });
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/CreateBucketCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/CreateBucketMetadataConfigurationCommand.js
var CreateBucketMetadataConfigurationCommand = class extends Command.classBuilder().ep({
	...
	return [getEndpointPlugin(config, Command.getEndpointParameterInstructions()), getFlexibleChecksumsPlugin(config, {
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/CreateBucketMetadataTableConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/CreateMultipartUploadCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteBucketAnalyticsConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteBucketCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteBucketCorsCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteBucketEncryptionCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteBucketIntelligentTieringConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteBucketInventoryConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteBucketLifecycleCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteBucketMetadataConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteBucketMetadataTableConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteBucketMetricsConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteBucketOwnershipControlsCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteBucketPolicyCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteBucketReplicationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteBucketTaggingCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteBucketWebsiteCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteObjectsCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeleteObjectTaggingCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/DeletePublicAccessBlockCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketAbacCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketAccelerateConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketAclCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketAnalyticsConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketCorsCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketEncryptionCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketIntelligentTieringConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketInventoryConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketLifecycleConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketLocationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketLoggingCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketMetadataConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketMetadataTableConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketMetricsConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketNotificationConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketOwnershipControlsCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketPolicyCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketPolicyStatusCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketReplicationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketRequestPaymentCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketTaggingCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketVersioningCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetBucketWebsiteCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetObjectAclCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetObjectAttributesCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetObjectLegalHoldCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetObjectLockConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetObjectRetentionCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetObjectTaggingCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetObjectTorrentCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/GetPublicAccessBlockCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/HeadBucketCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/HeadObjectCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/ListBucketAnalyticsConfigurationsCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/ListBucketIntelligentTieringConfigurationsCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/ListBucketInventoryConfigurationsCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/ListBucketMetricsConfigurationsCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/ListBucketsCommand.js
var ListBucketsCommand = class extends Command.classBuilder().ep(commonParams).m(function(Command, cs, config, o) {
	return [getEndpointPlugin(config, Command.getEndpointParameterInstructions()), getThrow200ExceptionsPlugin(config)];
}).s("AmazonS3", "ListBuckets", {}).n("S3Client", "ListBucketsCommand").sc(ListBuckets$).build() {};
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/ListDirectoryBucketsCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/ListMultipartUploadsCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/ListObjectsCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/ListObjectVersionsCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/ListPartsCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketAbacCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketAccelerateConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketAclCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketAnalyticsConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketEncryptionCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketIntelligentTieringConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketInventoryConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketLifecycleConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketLoggingCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketMetricsConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketNotificationConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketOwnershipControlsCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketPolicyCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketReplicationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketRequestPaymentCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketTaggingCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketVersioningCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutBucketWebsiteCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutObjectAclCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutObjectLegalHoldCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutObjectLockConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutObjectRetentionCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutObjectTaggingCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/PutPublicAccessBlockCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/RenameObjectCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/RestoreObjectCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/SelectObjectContentCommand.js
...
}).s("AmazonS3", "SelectObjectContent", { eventStream: { output: true } }).n("S3Client", "SelectObjectContentCommand").sc(SelectObjectContent$).build() {};
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/UpdateBucketMetadataInventoryTableConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/UpdateBucketMetadataJournalTableConfigurationCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/UpdateObjectEncryptionCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/UploadPartCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/UploadPartCopyCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/commands/WriteGetObjectResponseCommand.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/pagination/ListBucketsPaginator.js
var paginateListBuckets = createPaginator(S3Client, ListBucketsCommand, "ContinuationToken", "ContinuationToken", "MaxBuckets");
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/pagination/ListDirectoryBucketsPaginator.js
...
//#endregion
//#region node_modules/@smithy/util-waiter/dist-es/utils/sleep.js
var sleep = (seconds) => {
	return new Promise((resolve) => setTimeout(resolve, seconds * 1e3));
};
//#endregion
//#region node_modules/@smithy/util-waiter/dist-es/waiter.js
...
//#endregion
//#region node_modules/@smithy/util-waiter/dist-es/poller.js
...
//#endregion
//#region node_modules/@smithy/util-waiter/dist-es/utils/validate.js
...
//#endregion
//#region node_modules/@smithy/util-waiter/dist-es/createWaiter.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/waiters/waitForBucketExists.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/waiters/waitForBucketNotExists.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/waiters/waitForObjectExists.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/waiters/waitForObjectNotExists.js
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/S3.js
var commands = {
...
//#endregion
//#region node_modules/@aws-sdk/client-s3/dist-es/models/enums.js
var BucketAbacStatus = {
	Disabled: "Disabled",
	Enabled: "Enabled"
};
var RequestCharged = { requester: "requester" };
var RequestPayer = { requester: "requester" };
...
var OwnerOverride = { Destination: "Destination" };
var ChecksumType = {
	COMPOSITE: "COMPOSITE",
...
var BucketType = { Directory: "Directory" };
var LocationType = {
...
var AnalyticsS3ExportFileFormat = { CSV: "CSV" };
var StorageClassAnalysisSchemaVersion = { V_1: "V_1" };
var EncryptionType = {
	NONE: "NONE",
	SSE_C: "SSE-C"
};
...
var ChecksumMode = { ENABLED: "ENABLED" };
...
var ObjectLockEnabled = { Enabled: "Enabled" };
...
var OptionalObjectAttributes = { RESTORE_STATUS: "RestoreStatus" };
var ObjectVersionStorageClass = { STANDARD: "STANDARD" };
var MFADelete = {
	Disabled: "Disabled",
	Enabled: "Enabled"
};
