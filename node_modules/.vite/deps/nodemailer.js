...
import { t as require_browser_external_crypto } from "./browser-external_crypto-TMzmvXv8.js";
import { t as require_browser_external_zlib } from "./browser-external_zlib-TDSP5cT_.js";
import { t as require_browser_external_fs } from "./browser-external_fs-DKNe0WEE.js";
import { n as require_browser_external_util, t as require_browser_external_stream } from "./browser-external_stream-DwPxhmpx.js";
import { t as require_browser_external_path } from "./browser-external_path-CGCGhCRZ.js";
import { t as require_browser_external_url } from "./browser-external_url-D_CW-oMM.js";
import { t as require_browser_external_os } from "./browser-external_os-BnU-sRaQ.js";
import { i as require_browser_external_events, n as require_browser_external_net, r as require_browser_external_dns, t as require_browser_external_tls } from "./browser-external_tls-CIvRXN0Y.js";
import { n as require_browser_external_http, t as require_browser_external_https } from "./browser-external_https-CTnsqh3z.js";
import { t as require_browser_external_child_process } from "./browser-external_child_process-T7TSEieT.js";
//#region node_modules/nodemailer/lib/fetch/cookies.js
var require_cookies = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var urllib = require_browser_external_url();
...
var require_fetch = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var http = require_browser_external_http();
	var https = require_browser_external_https();
	var urllib = require_browser_external_url();
	var zlib = require_browser_external_zlib();
	var PassThrough = require_browser_external_stream().PassThrough;
	var Cookies = require_cookies();
	var packageData = require_package();
	var net = require_browser_external_net();
...
var require_shared = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports.resolveHostname = (options, callback) => {
		...
		if (!options.host || net.isIP(options.host)) return callback(null, formatDNSValue({
	...
	*/
	module.exports.resolveContent = (data, key, callback) => {
		...
		if (typeof content === "object") {
			...
			} else if (content.path) return resolveStream(fs.createReadStream(content.path), callback);
		}
...
var require_base64 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Transform = require_browser_external_stream().Transform;
	/**
...
var require_http_proxy_client = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	var net = require_browser_external_net();
	var tls = require_browser_external_tls();
	var urllib = require_browser_external_url();
	var errors = require_errors();
	/**
...
var require_sendmail_transport = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var spawn = require_browser_external_child_process().spawn;
	var packageData = require_package();
	var shared = require_shared();
	var errors = require_errors();
	/**
