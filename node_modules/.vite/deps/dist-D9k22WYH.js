...
import { At as _null, Bn as record, Dn as never, Dt as _enum, Gt as custom, Jt as discriminatedUnion, Mn as object$1, Nt as any, Pt as array$1, Rt as boolean, Un as strictObject, Wn as string, _n as lazy, jn as number, kt as _instanceof, nr as union, rr as unknown, vn as literal } from "./external-BZPJ4xeu.js";
import { $ as InvalidArgumentError$1, B as readResponseWithSizeLimit, C as getErrorMessage$1, D as isNonNullable, E as isAbortError, F as normalizeHeaders, G as validateDownloadUrl, H as safeParseJSON, I as parseJsonEventStream, J as withoutTrailingSlash, K as validateTypes, N as loadOptionalSetting, S as generateId, T as getRuntimeEnvironmentUserAgent, U as safeValidateTypes, V as resolve, X as AISDKError, Y as zodSchema, Z as APICallError, a as combineHeaders, ct as TypeValidationError, d as createEventSourceResponseHandler, dt as isJSONArray, et as InvalidPromptError, f as createIdGenerator, ft as isJSONObject, g as createProviderToolFactoryWithOutputSchema, i as asSchema, j as lazySchema, k as isUrlSupported, l as convertUint8ArrayToBase64, lt as UnsupportedFunctionalityError, m as createJsonResponseHandler, n as DelayedPromise, nt as JSONParseError, o as convertBase64ToUint8Array, ot as NoSuchModelError, p as createJsonErrorResponseHandler, q as withUserAgentSuffix, r as DownloadError, t as DEFAULT_MAX_DOWNLOAD_SIZE, ut as getErrorMessage, v as delay, w as getFromApi, x as executeTool, z as postJsonToApi } from "./dist-DeaSy8WZ.js";
...
var ToolLoopAgent = class {
	...
	*/
	...
	mergeCallbacks(settingsCallback, methodCallback) {
		if (methodCallback && settingsCallback) return async (event) => {
...
//#endregion
export { experimental_customProvider as $, UI_MESSAGE_STREAM_HEADERS as A, readUIMessageStream as At, createAgentUIStream as B, systemModelMessageSchema as Bt, RetryError as C, modelMessageSchema as Ct, ToolCallRepairError as D, pipeTextStreamToResponse as Dt, ToolCallNotFoundForApprovalError as E, pipeAgentUIStreamToResponse as Et, callCompletionApi as F, simulateStreamingMiddleware as Ft, createUIMessageStream as G, validateUIMessages as Gt, createDownload as H, transcribe as Ht, consumeStream as I, smoothStream as It, defaultEmbeddingSettingsMiddleware as J, wrapLanguageModel as Jt, createUIMessageStreamResponse as K, wrapEmbeddingModel as Kt, convertFileListToFileUIParts as L, stepCountIs as Lt, addToolInputExamplesMiddleware as M, rerank as Mt, assistantModelMessageSchema as N, safeValidateUIMessages as Nt, ToolLoopAgent as O, pipeUIMessageStreamToResponse as Ot, bindTelemetryIntegration as P, simulateReadableStream as Pt, experimental_createProviderRegistry as Q, convertToModelMessages as R, streamObject as Rt, NoVideoGeneratedError as S, lastAssistantMessageIsCompleteWithToolCalls as St, TextStreamChatTransport as T, parsePartialJson as Tt, createProviderRegistry as U, uiMessageChunkSchema as Ut, createAgentUIStreamResponse as V, toolModelMessageSchema as Vt, createTextStreamResponse as W, userModelMessageSchema as Wt, embed as X, createGatewayProvider as Xt, defaultSettingsMiddleware as Y, wrapProvider as Yt, embedMany as Z, gateway as Zt, NoOutputGeneratedError as _, isStaticToolUIPart as _t, HttpChatTransport as a, generateObject as at, NoSuchToolError as b, isToolUIPart as bt, InvalidMessageRoleError as c, getStaticToolName as ct, InvalidToolInputError as d, getToolOrDynamicToolName as dt, experimental_generateImage as et, JsonToSseTransformStream as f, hasToolCall as ft, NoObjectGeneratedError as g, isReasoningUIPart as gt, NoImageGeneratedError as h, isFileUIPart as ht, DirectChatTransport as i, generateImage as it, UnsupportedModelVersionError as j, registerTelemetryIntegration as jt, UIMessageStreamError as k, pruneMessages as kt, InvalidStreamPartError as l, getTextFromDataUrl as lt, MissingToolResultsError as m, isDeepEqualData as mt, DefaultChatTransport as n, extractJsonMiddleware as nt, InvalidArgumentError as o, generateSpeech as ot, MessageConversionError as p, isDataUIPart as pt, customProvider as q, wrapImageModel as qt, DefaultGeneratedFile as r, extractReasoningMiddleware as rt, InvalidDataContentError as s, generateText as st, AbstractChat as t, experimental_generateVideo as tt, InvalidToolApprovalError as u, getToolName as ut, NoSpeechGeneratedError as v, isTextUIPart as vt, SerialJobExecutor as w, output_exports as wt, NoTranscriptGeneratedError as x, lastAssistantMessageIsCompleteWithApprovalResponses as xt, NoSuchProviderError as y, isToolOrDynamicToolUIPart as yt, cosineSimilarity as z, streamText as zt };

//# sourceMappingURL=dist-D9k22WYH.js.map