...
var MiniMap = function(_a) {
	...
	var computeMiniMapStyle = function() {
		...
		Object.keys(style).forEach(function(key) {
			if (wrapperRef.current) wrapperRef.current.style[key] = style[key];
		});
	};
	var transformMiniMap = function() {
		...
		if (previewRef.current) {
			...
			var previewScale = computeMiniMapScale() * (1 / instance.transformState.scale);
	...
	return import_react.createElement("div", __assign({}, rest, {
		ref: mainRef,
		style: wrapperStyle,
		className: "rzpp-mini-map ".concat(rest.className || "")
	}), import_react.createElement("div", __assign({}, rest, {
		ref: wrapperRef,
		className: "rzpp-wrapper"
	}), children), import_react.createElement("div", {
		className: "rzpp-preview",
		ref: previewRef,
		style: __assign(__assign({}, previewStyles), { borderColor })
	}));
};
