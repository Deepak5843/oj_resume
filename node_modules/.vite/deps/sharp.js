...
import { t as require_browser_external_node_crypto } from "./browser-external_node_crypto-tI7RW6yJ.js";
import { t as require_browser_external_child_process } from "./browser-external_child_process-T7TSEieT.js";
import { n as require_browser_external_node_child_process, r as require_browser_external_node_os, t as require_browser_external_node_events } from "./browser-external_node_events-BCKya-E0.js";
...
var require_libvips = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	SPDX-License-Identifier: Apache-2.0
	*/
	var { spawnSync } = require_browser_external_node_child_process();
	var { createHash } = require_browser_external_node_crypto();
...
var require_constructor = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	SPDX-License-Identifier: Apache-2.0
	*/
	var util = require_browser_external_node_util();
	var stream = require_browser_external_node_stream();
	var is = require_is();
	require_sharp();
...
var require_utility = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	SPDX-License-Identifier: Apache-2.0
	*/
	var events = require_browser_external_node_events();
	var detectLibc = require_detect_libc();
	var is = require_is();
	...
	*/
	...
	else if (detectLibc.familySync() === detectLibc.MUSL && sharp.concurrency() === 1024) sharp.concurrency(require_browser_external_node_os().availableParallelism());
	/**
