...
var h = class {
	static generate(a = {}) {
		...
		if (a.length) {
			...
			return e = n / 10, i = n - 1, [`${Math.floor(Math.random() * (i - e)) + e}`];
		}
		return [`${Math.floor(Math.random() * (i - e)) + e}`];
	}
};
//#endregion
export { h as NumberDictionary, l as adjectives, r as animals, t as colors, o as countries, s as languages, d as names, y as starWars, n as uniqueNamesGenerator };
