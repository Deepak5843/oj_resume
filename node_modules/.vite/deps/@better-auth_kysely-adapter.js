import "./env-Cx6ouidE.js";
import "./error-CHLhyaje.js";
import "./error-BxR608yR.js";
import { C as SqliteDialect, G as Kysely, c as MssqlDialect, h as MysqlDialect, p as PostgresDialect, z as sql } from "./esm-DtSFVz7b.js";
import { n as createAdapterFactory } from "./adapter-D9I3_cxC.js";
...
var createKyselyAdapter = async (config) => {
	...
	if ("fileControl" in db) {
		const { BunSqliteDialect } = await import("./bun-sqlite-dialect-C8OaCWSL-Dsj7QV-X.js");
	...
	if ("createSession" in db) {
		...
		if (DatabaseSync && db instanceof DatabaseSync) {
			const { NodeSqliteDialect } = await import("./node-sqlite-dialect-CdB1xGQz.js");
			dialect = new NodeSqliteDialect({ database: db });
		}
	}
	if ("batch" in db && "exec" in db && "prepare" in db) {
		const { D1SqliteDialect } = await import("./d1-sqlite-dialect-sYHNqBte-hl3QYclg.js");
...
//# sourceMappingURL=@better-auth_kysely-adapter.js.map