...
import { r as mergeHeaders, t as dehydrateSsrMatchId } from "./ssr-match-id-D0MrjWX7.js";
import { i as decodePath } from "./utils-Cfwa4tVv.js";
import invariant from "./tiny-invariant.js";
import { c as GLOBAL_TSR, l as TSR_SCRIPT_BARRIER_ID, s as makeSsrSerovalPlugin, t as defaultSerovalPlugins, u as createLRUCache } from "./seroval-plugins-DmHVzW-H.js";
...
var import_web = (/* @__PURE__ */ __commonJSMin(((exports, module) => {
...
function transformPipeableStreamWithRouter(router, routerStream) {
	return import_browser_external_node_stream.Readable.fromWeb(transformStreamWithRouter(router, import_browser_external_node_stream.Readable.toWeb(routerStream)));
}
