import { C as once, D as replicateAsyncIterator, I as toArray, L as tryDecodeURIComponent, O as resolveMaybeOptionalOptions, _ as isObject, g as isAsyncIteratorObject, n as AsyncIteratorClass, p as getConstructor, v as isTypescriptObject } from "./dist-D6AwnVLs.js";
...
function replicateStandardLazyResponse(response, count) {
	...
	for (let i = 0; i < count; i++) replicated.push({
		...response,
		body: once(async () => {
			const body = await (bodyPromise ??= response.body());
			if (!isAsyncIteratorObject(body)) return body;
...
//#endregion
export { toORPCError as S, fallbackORPCErrorMessage as _, flattenHeader as a, isORPCErrorJson as b, getFilenameFromContentDisposition as c, withEventMeta as d, COMMON_ORPC_ERROR_DEFS as f, createORPCErrorFromJson as g, ORPC_CLIENT_PACKAGE_VERSION as h, encodeEventMessage as i, mergeStandardHeaders as l, ORPC_CLIENT_PACKAGE_NAME as m, EventDecoderStream as n, generateContentDisposition as o, ORPCError as p, HibernationEventIterator as r, getEventMeta as s, ErrorEvent as t, replicateStandardLazyResponse as u, fallbackORPCErrorStatus as v, isORPCErrorStatus as x, isDefinedError as y };

//# sourceMappingURL=dist-Cr8nxtrC.js.map