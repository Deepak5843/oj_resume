import { m as getCookie, r as createServerFn, v as setCookie$1 } from "./esm-m5_tZiEi.js";
import { t as createServerRpc } from "./createServerRpc-BR3zZJCy.js";
import z$1 from "zod";
//#region src/routes/dashboard/-components/functions.ts?tss-serverfn-split
...
var setDashboardSidebarServerFn = createServerFn({ method: "POST" }).inputValidator(z$1.boolean()).handler(setDashboardSidebarServerFn_createServerFn_handler, async ({ data }) => {
