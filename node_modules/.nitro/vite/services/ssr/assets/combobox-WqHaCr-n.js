...
//#endregion
//#region src/hooks/use-controlled-state.tsx
function useControlledState(props) {
	const { value, defaultValue, onChange } = props;
	const [state, setInternalState] = useState(value !== void 0 ? value : defaultValue);
	useEffect(() => {
		if (value !== void 0) setInternalState(value);
	}, [value]);
	return [state, useCallback((next, ...args) => {
...
var ComboboxRoot = Combobox.Root;
...
function ComboboxTrigger({ className, children, ...props }) {
	return /* @__PURE__ */ jsxs(Combobox.Trigger, {
		...
		...props,
		children: [children, /* @__PURE__ */ jsx(CaretDownIcon, { className: "pointer-events-none size-4 text-muted-foreground" })]
	});
}
...
function ComboboxItem({ className, children, ...props }) {
	return /* @__PURE__ */ jsxs(Combobox.Item, {
		...
		...props,
		children: [children, /* @__PURE__ */ jsx(Combobox.ItemIndicator, { render: /* @__PURE__ */ jsx("span", {
...
function Combobox$1(props) {
	...
	const findOption = React.useCallback((v) => {
		if (multiple) {
	...
	const resolvedValue = React.useMemo(() => props.value !== void 0 ? findOption(props.value) : void 0, [rawValueKey, optionMap]);
	const rawDefaultKey = props.defaultValue !== void 0 ? JSON.stringify(props.defaultValue) : void 0;
	const [selectedValue, setSelectedValue] = useControlledState({
		value: resolvedValue,
		defaultValue: React.useMemo(() => props.defaultValue !== void 0 ? findOption(props.defaultValue) : void 0, [rawDefaultKey, optionMap]),
		onChange: React.useCallback((option) => {
			if (multiple) {
	...
	const itemToStringLabel = React.useCallback((item) => typeof item.label === "string" ? item.label : String(item.value), []);
	const isItemEqualToValue = React.useCallback((a, b) => String(a.value) === String(b.value), []);
	const filter = React.useCallback((item, query) => {
	...
	const listContent = (item) => /* @__PURE__ */ jsx(ComboboxItem, {
		value: item,
	...
	return /* @__PURE__ */ jsxs(ComboboxRoot, {
		...
		children: [/* @__PURE__ */ jsxs(ComboboxTrigger, {
			id,
			disabled,
			...
			children: [/* @__PURE__ */ jsx("span", {
				...
				children: /* @__PURE__ */ jsx(ComboboxValue, { placeholder: placeholder ?? i18n._({ id: "O/7I0o" }) })
			...
			/* @__PURE__ */ jsx(ComboboxEmpty, { children: emptyMessage ?? i18n._({ id: "MZbQHL" }) }),
			/* @__PURE__ */ jsx(ComboboxList, { children: listContent })
		] })]
	});
}
//#endregion
export { InputGroupButton as a, InputGroupAddon as i, useControlledState as n, InputGroupInput as o, InputGroup as r, InputGroupText as s, Combobox$1 as t };
