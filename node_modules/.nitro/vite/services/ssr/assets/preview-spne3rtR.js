import { c as pageDimensionsAsPixels, d as sanitizeCss } from "./client-BWxMxJtI.js";
import { t as cn } from "./style-Dwb9U8QV.js";
import { n as AlertDescription, r as AlertTitle, t as Alert } from "./alert-CTJXrILL.js";
import { a as stripHtml } from "./string-DcW5i2yt.js";
import { i as TiptapContent, t as useResumeStore } from "./resume-ChldmFWM.js";
import { a as LevelDisplay, c as useCSSVariables, n as getSectionTitle, o as PageIcon, s as webfontlist_default } from "./section-C5EoZxrX.js";
import { useEffect, useMemo, useRef, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { Trans } from "@lingui/react";
import { ArrowRightIcon, EnvelopeIcon, GlobeIcon, IconContext, MapPinIcon, PhoneIcon, WarningIcon } from "@phosphor-icons/react";
import { match } from "ts-pattern";
import { useIsMounted, useResizeObserver } from "usehooks-ts";
//#region src/components/resume/hooks/use-webfonts.tsx
...
//#endregion
//#region src/components/resume/shared/linked-title.tsx
function LinkedTitle({ title, website, showLinkInTitle, className }) {
	if (showLinkInTitle && website?.url) return /* @__PURE__ */ jsx("a", {
		href: website.url,
		target: "_blank",
		rel: "noopener",
		className: cn("inline-block", className),
		children: /* @__PURE__ */ jsx("strong", { children: title })
	});
...
//#endregion
//#region src/components/resume/shared/page-link.tsx
...
//#endregion
//#region src/components/resume/shared/items/awards-item.tsx
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(LinkedTitle, {
						title: item.title,
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx(TiptapContent, { content: item.description })
			}),
			!item.options?.showLinkInTitle && /* @__PURE__ */ jsx("div", {
				className: "section-item-website awards-item-website",
				children: /* @__PURE__ */ jsx(PageLink, {
					...item.website,
...
//#endregion
//#region src/components/resume/shared/items/certifications-item.tsx
...
//#endregion
//#region src/components/resume/shared/items/cover-letter-item.tsx
function CoverLetterItem({ className, ...item }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsx(TiptapContent, { content: item.recipient })
		}), /* @__PURE__ */ jsx("div", {
			className: cn("cover-letter-item-content", !stripHtml(item.content) && "hidden"),
			children: /* @__PURE__ */ jsx(TiptapContent, { content: item.content })
		})]
	});
}
//#endregion
//#region src/components/resume/shared/items/education-item.tsx
...
//#endregion
//#region src/components/resume/shared/items/experience-item.tsx
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					(!hasRoles || item.position) && /* @__PURE__ */ jsxs("div", {
						className: "flex items-start justify-between gap-x-2",
						children: [/* @__PURE__ */ jsx("span", {
					...
					hasRoles && !item.position && item.period && /* @__PURE__ */ jsx("div", {
			...
			hasRoles && /* @__PURE__ */ jsx("div", {
				className: "experience-item-roles mt-0 flex flex-col gap-y-1",
				children: item.roles.map((role) => /* @__PURE__ */ jsxs("div", {
					...
					}), stripHtml(role.description) && /* @__PURE__ */ jsx("div", {
						className: "section-item-description experience-item-role-description mt-0.5",
						children: /* @__PURE__ */ jsx(TiptapContent, { content: role.description })
					})]
				}, role.id))
			}),
			!hasRoles && /* @__PURE__ */ jsx("div", {
...
//#endregion
//#region src/components/resume/shared/items/interests-item.tsx
function InterestsItem({ className, ...item }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(PageIcon, {
				icon: item.icon,
		...
		}), item.keywords.length > 0 && /* @__PURE__ */ jsx("span", {
...
//#endregion
//#region src/components/resume/shared/items/languages-item.tsx
...
//#endregion
//#region src/components/resume/shared/items/profiles-item.tsx
function ProfilesItem({ className, ...item }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			}), /* @__PURE__ */ jsx(LinkedTitle, {
				title: item.network,
				website: item.website,
				showLinkInTitle: item.options?.showLinkInTitle,
				className: "section-item-title profiles-item-network"
			})]
		}), !item.options?.showLinkInTitle && /* @__PURE__ */ jsx(PageLink, {
			...item.website,
...
//#endregion
//#region src/components/resume/shared/items/projects-item.tsx
...
//#endregion
//#region src/components/resume/shared/items/publications-item.tsx
...
//#endregion
//#region src/components/resume/shared/items/references-item.tsx
...
//#endregion
//#region src/components/resume/shared/items/skills-item.tsx
...
//#endregion
//#region src/components/resume/shared/items/summary-item.tsx
...
//#endregion
//#region src/components/resume/shared/items/volunteer-item.tsx
...
//#endregion
//#region src/components/resume/shared/page-section.tsx
...
//#endregion
//#region src/components/resume/shared/page-summary.tsx
function PageSummary({ className }) {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("h6", {
			...
			children: /* @__PURE__ */ jsx(TiptapContent, {
...
//#endregion
//#region src/components/resume/shared/get-section-component.tsx
function renderItemByType(type, item, itemClassName) {
	return match(type).with("summary", () => /* @__PURE__ */ jsx(SummaryItem, {
		...item,
		className: itemClassName
	})).with("profiles", () => /* @__PURE__ */ jsx(ProfilesItem, {
		...item,
		className: itemClassName
	})).with("experience", () => /* @__PURE__ */ jsx(ExperienceItem, {
		...item,
		className: itemClassName
	})).with("education", () => /* @__PURE__ */ jsx(EducationItem, {
		...item,
		className: itemClassName
	})).with("projects", () => /* @__PURE__ */ jsx(ProjectsItem, {
		...item,
		className: itemClassName
	})).with("skills", () => /* @__PURE__ */ jsx(SkillsItem, {
		...item,
		className: itemClassName
	})).with("languages", () => /* @__PURE__ */ jsx(LanguagesItem, {
		...item,
		className: itemClassName
	})).with("interests", () => /* @__PURE__ */ jsx(InterestsItem, {
		...item,
		className: itemClassName
	})).with("awards", () => /* @__PURE__ */ jsx(AwardsItem, {
		...item,
		className: itemClassName
	})).with("certifications", () => /* @__PURE__ */ jsx(CertificationsItem, {
		...item,
		className: itemClassName
	})).with("publications", () => /* @__PURE__ */ jsx(PublicationsItem, {
		...item,
		className: itemClassName
	})).with("volunteer", () => /* @__PURE__ */ jsx(VolunteerItem, {
		...item,
		className: itemClassName
	})).with("references", () => /* @__PURE__ */ jsx(ReferencesItem, {
		...item,
		className: itemClassName
	})).with("cover-letter", () => /* @__PURE__ */ jsx(CoverLetterItem, {
		...item,
		className: itemClassName
	})).exhaustive();
}
function getSectionComponent(section, { sectionClassName, itemClassName } = {}) {
	return match(section).with("summary", () => {
		const SummarySection = (_) => /* @__PURE__ */ jsx(PageSummary, { className: sectionClassName });
		return SummarySection;
	}).with("profiles", () => {
		const ProfilesSection = (_) => /* @__PURE__ */ jsx(PageSection, {
			type: "profiles",
			className: sectionClassName,
			children: (item) => /* @__PURE__ */ jsx(ProfilesItem, {
				...item,
				className: itemClassName
			})
		});
		...
		const ExperienceSection = (_) => /* @__PURE__ */ jsx(PageSection, {
			type: "experience",
			className: sectionClassName,
			children: (item) => /* @__PURE__ */ jsx(ExperienceItem, {
				...item,
				className: itemClassName
			})
		});
		...
		const EducationSection = (_) => /* @__PURE__ */ jsx(PageSection, {
			type: "education",
			className: sectionClassName,
			children: (item) => /* @__PURE__ */ jsx(EducationItem, {
				...item,
				className: itemClassName
			})
		});
		...
		const ProjectsSection = (_) => /* @__PURE__ */ jsx(PageSection, {
			type: "projects",
			className: sectionClassName,
			children: (item) => /* @__PURE__ */ jsx(ProjectsItem, {
				...item,
				className: itemClassName
			})
		});
		...
		const SkillsSection = (_) => /* @__PURE__ */ jsx(PageSection, {
			type: "skills",
			className: sectionClassName,
			children: (item) => /* @__PURE__ */ jsx(SkillsItem, {
				...item,
				className: itemClassName
			})
		});
		...
		const LanguagesSection = (_) => /* @__PURE__ */ jsx(PageSection, {
			type: "languages",
			className: sectionClassName,
			children: (item) => /* @__PURE__ */ jsx(LanguagesItem, {
				...item,
				className: itemClassName
			})
		});
		...
		const InterestsSection = (_) => /* @__PURE__ */ jsx(PageSection, {
			type: "interests",
			className: sectionClassName,
			children: (item) => /* @__PURE__ */ jsx(InterestsItem, {
				...item,
				className: itemClassName
			})
		});
		...
		const AwardsSection = (_) => /* @__PURE__ */ jsx(PageSection, {
			type: "awards",
			className: sectionClassName,
			children: (item) => /* @__PURE__ */ jsx(AwardsItem, {
				...item,
				className: itemClassName
			})
		});
		...
		const CertificationsSection = (_) => /* @__PURE__ */ jsx(PageSection, {
			type: "certifications",
			className: sectionClassName,
			children: (item) => /* @__PURE__ */ jsx(CertificationsItem, {
				...item,
				className: itemClassName
			})
		});
		...
		const PublicationsSection = (_) => /* @__PURE__ */ jsx(PageSection, {
			type: "publications",
			className: sectionClassName,
			children: (item) => /* @__PURE__ */ jsx(PublicationsItem, {
				...item,
				className: itemClassName
			})
		});
		...
		const VolunteerSection = (_) => /* @__PURE__ */ jsx(PageSection, {
			type: "volunteer",
			className: sectionClassName,
			children: (item) => /* @__PURE__ */ jsx(VolunteerItem, {
				...item,
				className: itemClassName
			})
		});
		...
		const ReferencesSection = (_) => /* @__PURE__ */ jsx(PageSection, {
			type: "references",
			className: sectionClassName,
			children: (item) => /* @__PURE__ */ jsx(ReferencesItem, {
				...item,
				className: itemClassName
			})
		});
		...
		const CustomSectionComponent = ({ id }) => {
			...
			return /* @__PURE__ */ jsxs("section", {
				...
				children: [customSection.type !== "cover-letter" && /* @__PURE__ */ jsx("h6", {
					className: "mb-1.5 text-(--page-primary-color)",
					children: customSection.title
				}), /* @__PURE__ */ jsx("div", {
					className: "section-content grid gap-x-(--page-gap-x) gap-y-(--page-gap-y)",
					style: { gridTemplateColumns: `repeat(${customSection.columns}, 1fr)` },
					children: visibleItems.map((item) => /* @__PURE__ */ jsx("div", {
...
//#endregion
//#region src/components/resume/shared/page-picture.tsx
...
//#endregion
//#region src/components/resume/templates/azurill.tsx
...
function AzurillTemplate({ pageIndex, pageLayout }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [isFirstPage && /* @__PURE__ */ jsx(Header$12, {}), /* @__PURE__ */ jsxs("div", {
			className: "flex gap-x-(--page-gap-x)",
			children: [!fullWidth && /* @__PURE__ */ jsx("aside", {
				"data-layout": "sidebar",
				...
				children: sidebar.map((section) => {
					return /* @__PURE__ */ jsx(getSectionComponent(section, { sectionClassName: sectionClassName$12 }), { id: section }, section);
				})
			}), /* @__PURE__ */ jsx("main", {
				"data-layout": "main",
...
function Header$12() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(PagePicture, {}), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					basics.email && /* @__PURE__ */ jsxs("div", {
						className: "basics-item-email",
						children: [/* @__PURE__ */ jsx(EnvelopeIcon, {}), /* @__PURE__ */ jsx(PageLink, {
							url: `mailto:${basics.email}`,
							label: basics.email
						})]
					}),
					basics.phone && /* @__PURE__ */ jsxs("div", {
						className: "basics-item-phone",
						children: [/* @__PURE__ */ jsx(PhoneIcon, {}), /* @__PURE__ */ jsx(PageLink, {
							url: `tel:${basics.phone}`,
							label: basics.phone
						})]
					}),
					basics.location && /* @__PURE__ */ jsxs("div", {
						className: "basics-item-location",
						children: [/* @__PURE__ */ jsx(MapPinIcon, {}), /* @__PURE__ */ jsx("span", { children: basics.location })]
					}),
					basics.website.url && /* @__PURE__ */ jsxs("div", {
						className: "basics-item-website",
						children: [/* @__PURE__ */ jsx(GlobeIcon, {}), /* @__PURE__ */ jsx(PageLink, { ...basics.website })]
					}),
					basics.customFields.map((field) => /* @__PURE__ */ jsxs("div", {
						className: "basics-item-custom",
						children: [/* @__PURE__ */ jsx(PageIcon, { icon: field.icon }), field.link ? /* @__PURE__ */ jsx(PageLink, {
							url: field.link,
							label: field.text
						}) : /* @__PURE__ */ jsx("span", { children: field.text })]
					}, field.id))
				]
			})]
		})]
...
//#endregion
//#region src/components/resume/templates/bronzor.tsx
...
function BronzorTemplate({ pageIndex, pageLayout }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [isFirstPage && /* @__PURE__ */ jsx(Header$11, {}), /* @__PURE__ */ jsxs("div", {
			className: "space-y-(--page-gap-y)",
			children: [/* @__PURE__ */ jsx("main", {
				"data-layout": "main",
				className: "group page-main space-y-(--page-gap-y)",
				children: main.map((section) => {
					return /* @__PURE__ */ jsx(getSectionComponent(section, { sectionClassName: sectionClassName$11 }), { id: section }, section);
				})
			}), !fullWidth && /* @__PURE__ */ jsx("aside", {
				"data-layout": "sidebar",
...
//#endregion
//#region src/components/resume/templates/chikorita.tsx
...
function ChikoritaTemplate({ pageIndex, pageLayout }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [!fullWidth && /* @__PURE__ */ jsx("div", { className: "page-sidebar-background pointer-events-none absolute inset-y-0 z-0 w-(--page-sidebar-width) shrink-0 bg-(--page-primary-color) ltr:inset-e-0 rtl:inset-s-0" }), /* @__PURE__ */ jsxs("div", {
			className: "flex",
			children: [/* @__PURE__ */ jsxs("main", {
				"data-layout": "main",
				className: "group page-main z-10 flex-1 space-y-4 px-(--page-margin-x) pt-(--page-margin-y)",
				children: [isFirstPage && /* @__PURE__ */ jsx(Header$10, {}), main.map((section) => {
					return /* @__PURE__ */ jsx(getSectionComponent(section, { sectionClassName: sectionClassName$10 }), { id: section }, section);
				})]
			}), !fullWidth && /* @__PURE__ */ jsx("aside", {
				"data-layout": "sidebar",
...
//#endregion
//#region src/components/resume/templates/ditgar.tsx
...
function DitgarTemplate({ pageIndex, pageLayout }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [(!fullWidth || isFirstPage) && /* @__PURE__ */ jsx("div", { className: "page-sidebar-background pointer-events-none absolute inset-y-0 z-0 w-(--page-sidebar-width) shrink-0 bg-(--page-primary-color)/20 ltr:inset-s-0 rtl:inset-e-0" }), /* @__PURE__ */ jsxs("div", {
			className: "flex",
			children: [(!fullWidth || isFirstPage) && /* @__PURE__ */ jsxs("aside", {
				"data-layout": "sidebar",
				className: "sidebar group z-10 flex w-(--page-sidebar-width) shrink-0 flex-col",
				children: [isFirstPage && /* @__PURE__ */ jsx(Header$9, {}), /* @__PURE__ */ jsx("div", {
					className: "flex-1 space-y-4 px-(--page-margin-x) pt-(--page-margin-y)",
					children: sidebar.map((section) => {
						return /* @__PURE__ */ jsx(getSectionComponent(section, { sectionClassName: sectionClassName$9 }), { id: section }, section);
					})
				})]
			}), /* @__PURE__ */ jsx("main", {
				"data-layout": "main",
				...
				children: [
					basics.location && /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(PageIcon, {
							icon: "map-pin",
							className: "ph-bold"
						}), /* @__PURE__ */ jsx("div", { children: basics.location })]
					}),
					basics.phone && /* @__PURE__ */ jsxs("div", {
					...
					basics.website.url && /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(PageIcon, {
							icon: "globe",
							className: "ph-bold"
						}), /* @__PURE__ */ jsx(PageLink, { ...basics.website })]
					}),
					basics.customFields.map((field) => /* @__PURE__ */ jsxs("div", {
...
//#endregion
//#region src/components/resume/templates/ditto.tsx
...
function DittoTemplate({ pageIndex, pageLayout }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [isFirstPage && /* @__PURE__ */ jsx(Header$8, {}), /* @__PURE__ */ jsxs("div", {
			...
			children: [!fullWidth && /* @__PURE__ */ jsx("aside", {
				...
				children: sidebar.map((section) => {
					return /* @__PURE__ */ jsx(getSectionComponent(section, { sectionClassName: sectionClassName$8 }), { id: section }, section);
				})
			}), /* @__PURE__ */ jsx("main", {
				"data-layout": "main",
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx(PagePicture, { className: "absolute top-8" })
				}), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("div", { className: "w-(--page-sidebar-width) shrink-0" }), /* @__PURE__ */ jsxs("div", {
...
//#endregion
//#region src/components/resume/templates/gengar.tsx
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [(!fullWidth || isFirstPage) && /* @__PURE__ */ jsx("div", { className: "page-sidebar-background pointer-events-none absolute inset-y-0 z-0 w-(--page-sidebar-width) shrink-0 bg-(--page-primary-color)/20 ltr:inset-s-0 rtl:inset-e-0" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [(!fullWidth || isFirstPage) && /* @__PURE__ */ jsxs("aside", {
				...
				children: [isFirstPage && /* @__PURE__ */ jsx(Header$7, {}), !fullWidth && /* @__PURE__ */ jsx("div", {
					...
					children: sidebar.filter((section) => section !== "summary").map((section) => {
						return /* @__PURE__ */ jsx(getSectionComponent(section, { sectionClassName: sectionClassName$7 }), { id: section }, section);
					})
				})]
			}), /* @__PURE__ */ jsxs("main", {
				"data-layout": "main",
				className: "group page-main z-10",
				children: [isFirstPage && /* @__PURE__ */ jsx(PageSummary, { className: cn(sectionClassName$7, "bg-(--page-primary-color)/20 px-(--page-margin-x) py-(--page-margin-y) [&>h6]:hidden") }), /* @__PURE__ */ jsx("div", {
					className: "space-y-4 px-(--page-margin-x) pt-(--page-margin-y)",
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						basics.email && /* @__PURE__ */ jsxs("div", {
							className: "basics-item-email",
							children: [/* @__PURE__ */ jsx(PageIcon, { icon: "envelope" }), /* @__PURE__ */ jsx(PageLink, {
								url: `mailto:${basics.email}`,
								label: basics.email
							})]
						}),
						basics.phone && /* @__PURE__ */ jsxs("div", {
							className: "basics-item-phone",
							children: [/* @__PURE__ */ jsx(PageIcon, { icon: "phone" }), /* @__PURE__ */ jsx(PageLink, {
								url: `tel:${basics.phone}`,
								label: basics.phone
							})]
						}),
						basics.location && /* @__PURE__ */ jsxs("div", {
							className: "basics-item-location",
							children: [/* @__PURE__ */ jsx(PageIcon, { icon: "map-pin" }), /* @__PURE__ */ jsx("span", { children: basics.location })]
						}),
						basics.website.url && /* @__PURE__ */ jsxs("div", {
							className: "basics-item-website",
							children: [/* @__PURE__ */ jsx(PageIcon, { icon: "globe" }), /* @__PURE__ */ jsx(PageLink, { ...basics.website })]
						}),
						basics.customFields.map((field) => /* @__PURE__ */ jsxs("div", {
							className: "basics-item-custom",
							children: [/* @__PURE__ */ jsx(PageIcon, { icon: field.icon }), field.link ? /* @__PURE__ */ jsx(PageLink, {
...
//#endregion
//#region src/components/resume/templates/glalie.tsx
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [(!fullWidth || isFirstPage) && /* @__PURE__ */ jsx("div", { className: "page-sidebar-background pointer-events-none absolute inset-y-0 z-0 w-(--page-sidebar-width) shrink-0 bg-(--page-primary-color)/20 ltr:inset-s-0 rtl:inset-e-0" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [(!fullWidth || isFirstPage) && /* @__PURE__ */ jsxs("aside", {
				...
				children: [isFirstPage && /* @__PURE__ */ jsx(Header$6, {}), !fullWidth && /* @__PURE__ */ jsx("div", {
					className: "shrink-0 space-y-4 overflow-x-hidden",
					children: sidebar.map((section) => {
						return /* @__PURE__ */ jsx(getSectionComponent(section, { sectionClassName: sectionClassName$6 }), { id: section }, section);
					})
				})]
			}), /* @__PURE__ */ jsx("main", {
				"data-layout": "main",
...
//#endregion
//#region src/components/resume/templates/kakuna.tsx
...
function KakunaTemplate({ pageIndex, pageLayout }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			isFirstPage && /* @__PURE__ */ jsx(Header$5, {}),
			/* @__PURE__ */ jsx("main", {
				"data-layout": "main",
				className: "group page-main space-y-(--page-gap-y)",
				children: main.map((section) => {
					return /* @__PURE__ */ jsx(getSectionComponent(section, { sectionClassName: sectionClassName$5 }), { id: section }, section);
				})
			}),
			!fullWidth && /* @__PURE__ */ jsx("aside", {
				"data-layout": "sidebar",
...
//#endregion
//#region src/components/resume/templates/lapras.tsx
...
function LaprasTemplate({ pageIndex, pageLayout }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			isFirstPage && /* @__PURE__ */ jsx(Header$4, {}),
			/* @__PURE__ */ jsx("main", {
				"data-layout": "main",
				className: "group page-main space-y-6",
				children: main.map((section) => {
					return /* @__PURE__ */ jsx(getSectionComponent(section, { sectionClassName: sectionClassName$4 }), { id: section }, section);
				})
			}),
			!fullWidth && /* @__PURE__ */ jsx("aside", {
				"data-layout": "sidebar",
...
//#endregion
//#region src/components/resume/templates/leafish.tsx
...
function LeafishTemplate({ pageIndex, pageLayout }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [isFirstPage && /* @__PURE__ */ jsx(Header$3, {}), /* @__PURE__ */ jsxs("div", {
			className: "flex gap-x-(--page-margin-x) px-(--page-margin-x) pt-(--page-margin-y)",
			children: [/* @__PURE__ */ jsx("main", {
				"data-layout": "main",
				className: "group page-main space-y-(--page-gap-y)",
				children: main.filter((section) => section !== "summary").map((section) => {
					return /* @__PURE__ */ jsx(getSectionComponent(section, { sectionClassName: sectionClassName$3 }), { id: section }, section);
				})
			}), !fullWidth && /* @__PURE__ */ jsx("aside", {
				"data-layout": "sidebar",
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(PagePicture, {}), /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
					...
					className: "basics-headline",
					children: basics.headline
				})] }), /* @__PURE__ */ jsx(PageSummary, { className: "[&>h6]:hidden" })]
			})]
		}), /* @__PURE__ */ jsx("div", {
...
//#endregion
//#region src/components/resume/templates/onyx.tsx
...
function OnyxTemplate({ pageIndex, pageLayout }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			isFirstPage && /* @__PURE__ */ jsx(Header$2, {}),
			/* @__PURE__ */ jsx("main", {
				"data-layout": "main",
				className: "group page-main space-y-(--page-gap-y)",
				children: main.map((section) => {
					return /* @__PURE__ */ jsx(getSectionComponent(section, { sectionClassName: sectionClassName$2 }), { id: section }, section);
				})
			}),
			!fullWidth && /* @__PURE__ */ jsx("aside", {
				"data-layout": "sidebar",
...
//#endregion
//#region src/components/resume/templates/pikachu.tsx
...
function PikachuTemplate({ pageIndex, pageLayout }) {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [!fullWidth && /* @__PURE__ */ jsxs("aside", {
				"data-layout": "sidebar",
				className: "group page-sidebar flex w-(--page-sidebar-width) shrink-0 flex-col space-y-(--page-gap-y)",
				children: [isFirstPage && /* @__PURE__ */ jsx("div", {
					className: "flex max-w-(--page-sidebar-width) items-center justify-start",
					children: /* @__PURE__ */ jsx(PagePicture, {})
				}), !fullWidth && /* @__PURE__ */ jsx("div", {
					className: "shrink-0 space-y-(--page-gap-y) overflow-x-hidden",
					children: sidebar.map((section) => {
						return /* @__PURE__ */ jsx(getSectionComponent(section, { sectionClassName: sectionClassName$1 }), { id: section }, section);
					})
				})]
			}), /* @__PURE__ */ jsxs("main", {
				"data-layout": "main",
				className: "group page-main flex-1 space-y-(--page-gap-y)",
				children: [isFirstPage && /* @__PURE__ */ jsxs("div", {
					className: "flex items-center gap-x-6",
					children: [fullWidth && /* @__PURE__ */ jsx(PagePicture, {}), /* @__PURE__ */ jsx(Header$1, {})]
				}), /* @__PURE__ */ jsx("div", {
					className: "space-y-(--page-gap-y)",
					children: main.map((section) => {
						return /* @__PURE__ */ jsx(getSectionComponent(section, { sectionClassName: sectionClassName$1 }), { id: section }, section);
...
//#endregion
//#region src/components/resume/templates/rhyhorn.tsx
...
function RhyhornTemplate({ pageIndex, pageLayout }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			isFirstPage && /* @__PURE__ */ jsx(Header, {}),
			/* @__PURE__ */ jsx("main", {
				"data-layout": "main",
				className: "group page-main space-y-(--page-gap-y)",
				children: main.map((section) => {
					return /* @__PURE__ */ jsx(getSectionComponent(section, { sectionClassName }), { id: section }, section);
				})
			}),
			!fullWidth && /* @__PURE__ */ jsx("aside", {
				"data-layout": "sidebar",
...
//#endregion
//#region src/components/resume/preview.tsx
...
var ResumePreview = ({ showPageNumbers = false, pageClassName, className, ...props }) => {
	...
	return /* @__PURE__ */ jsxs(IconContext.Provider, {
		value: iconProps,
		children: [scopedCSS && /* @__PURE__ */ jsx("style", { dangerouslySetInnerHTML: { __html: scopedCSS } }), /* @__PURE__ */ jsx("div", {
			style,
			className: cn("resume-preview-container", className),
			...props,
			children: metadata.layout.pages.map((pageLayout, pageIndex) => /* @__PURE__ */ jsx(PageContainer, {
				pageIndex,
				pageLayout,
				pageClassName,
				showPageNumbers
...
function PageContainer({ pageIndex, pageLayout, pageClassName, showPageNumbers = false }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		className: "relative",
		children: [
			showPageNumbers && totalNumberOfPages > 1 && /* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx(TemplateComponent, {
					pageIndex,
					pageLayout
				})
			}),
			metadata.page.format !== "free-form" && pageHeight > maxPageHeight && /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx("a", {
					...
					children: /* @__PURE__ */ jsxs(Alert, {
						...
						children: [
							/* @__PURE__ */ jsx(WarningIcon, { color: "currentColor" }),
							/* @__PURE__ */ jsx(AlertTitle, { children: /* @__PURE__ */ jsx(Trans, { id: "9y0oTl" }) }),
							/* @__PURE__ */ jsxs(AlertDescription, {
								className: "text-xs underline-offset-2 group-hover/link:underline",
								children: [/* @__PURE__ */ jsx(Trans, { id: "DiDD1p" }), /* @__PURE__ */ jsx(ArrowRightIcon, {
									color: "currentColor",
