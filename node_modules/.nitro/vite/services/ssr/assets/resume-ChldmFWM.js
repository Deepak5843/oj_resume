import { f as sanitizeHtml, r as orpc } from "./client-BWxMxJtI.js";
import { t as cn } from "./style-Dwb9U8QV.js";
import { t as Button } from "./button-C8loFr-r.js";
import { r as isRTL } from "./locale-Bc_Sesmg.js";
...
import { a as DropdownMenuItem, c as DropdownMenuSeparator, f as DropdownMenuTrigger, n as DropdownMenuCheckboxItem, r as DropdownMenuContent, t as DropdownMenu } from "./dropdown-menu-Bf0lPMdM.js";
import * as React from "react";
import { useMemo, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { Trans, useLingui } from "@lingui/react";
import { ArrowsInSimpleIcon, ArrowsOutSimpleIcon, CodeBlockIcon, CodeSimpleIcon, ColumnsPlusLeftIcon, ColumnsPlusRightIcon, HighlighterCircleIcon, KeyReturnIcon, LinkBreakIcon, LinkIcon, ListBulletsIcon, ListNumbersIcon, MinusIcon, ParagraphIcon, PlusIcon, RowsPlusBottomIcon, RowsPlusTopIcon, TableIcon, TextAlignCenterIcon, TextAlignJustifyIcon, TextAlignLeftIcon, TextAlignRightIcon, TextBolderIcon, TextHFiveIcon, TextHFourIcon, TextHOneIcon, TextHSixIcon, TextHThreeIcon, TextHTwoIcon, TextIndentIcon, TextItalicIcon, TextOutdentIcon, TextStrikethroughIcon, TextUnderlineIcon, TrashSimpleIcon, XIcon } from "@phosphor-icons/react";
	...
	return /* @__PURE__ */ jsxs(DialogPortal, { children: [/* @__PURE__ */ jsx(DialogOverlay, {}), /* @__PURE__ */ jsxs(Dialog.Popup, {
		...
		children: [children, showClose && /* @__PURE__ */ jsxs(Dialog.Close, {
			...
			children: [/* @__PURE__ */ jsx(XIcon, {}), /* @__PURE__ */ jsx("span", {
				className: "sr-only",
				children: /* @__PURE__ */ jsx(Trans, { id: "yz7wBu" })
			})]
		})]
	})] });
}
...
//#endregion
//#region src/hooks/use-prompt.tsx
var PromptContext = React.createContext(null);
function PromptDialogProvider({ children }) {
	...
	const prompt = React.useCallback(async (title, options) => {
	...
	return /* @__PURE__ */ jsxs(PromptContext.Provider, {
		value: { prompt },
		children: [children, /* @__PURE__ */ jsx(AlertDialog, {
			open: state.open,
			onOpenChange: (open) => !open && handleCancel(),
			children: /* @__PURE__ */ jsxs(AlertDialogContent, { children: [
				/* @__PURE__ */ jsxs(AlertDialogHeader, { children: [/* @__PURE__ */ jsx(AlertDialogTitle, { children: state.title }), /* @__PURE__ */ jsx(AlertDialogDescription, {
...
//#endregion
//#region src/components/input/rich-input.tsx
var extensions = [
	...
	Highlight.configure({ HTMLAttributes: { class: "rounded-md px-0.5 py-px" } }),
...
function RichInput({ value, onChange, style, className, editorClassName, ...options }) {
	...
	const editorElement = /* @__PURE__ */ jsxs("div", {
		className: "relative",
		children: [
			...
			/* @__PURE__ */ jsx(Button, {
				...
				children: isFullscreen ? /* @__PURE__ */ jsx(ArrowsInSimpleIcon, { className: "size-4" }) : /* @__PURE__ */ jsx(ArrowsOutSimpleIcon, { className: "size-4" })
			})
		]
	});
	if (isFullscreen) return /* @__PURE__ */ jsxs(EditorContext, {
		value: providerValue,
		children: [/* @__PURE__ */ jsx("div", {
			className: cn("rounded-md", className),
			style,
			children: /* @__PURE__ */ jsx("div", { className: "h-[200px] rounded-md border border-dashed" })
			...
			children: /* @__PURE__ */ jsxs(DialogContent, {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					className: "sr-only",
					children: [/* @__PURE__ */ jsx(DialogTitle, { children: "Fullscreen Editor" }), /* @__PURE__ */ jsx(DialogDescription, { children: "Edit content in fullscreen mode" })]
				}), editorElement]
			})
		})]
	});
	return /* @__PURE__ */ jsx(EditorContext, {
		value: providerValue,
		children: /* @__PURE__ */ jsx("div", {
			className: cn("rounded-md", className),
			style,
		...
		selector: (ctx) => {
			return {
				...
				setLink: async () => {
					...
					if (!z$1.url({ protocol: /^https?$/ }).safeParse(url).success) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx(Toggle$1, {
				...
				children: /* @__PURE__ */ jsx(TextBolderIcon, { className: "size-3.5" })
			}),
			/* @__PURE__ */ jsx(Toggle$1, {
				size: isFullscreen ? "lg" : "sm",
				tabIndex: -1,
				...
				children: /* @__PURE__ */ jsx(TextItalicIcon, { className: "size-3.5" })
			}),
			/* @__PURE__ */ jsx(Toggle$1, {
				size: isFullscreen ? "lg" : "sm",
				tabIndex: -1,
				...
				children: /* @__PURE__ */ jsx(TextUnderlineIcon, { className: "size-3.5" })
			}),
			/* @__PURE__ */ jsx(Toggle$1, {
				size: isFullscreen ? "lg" : "sm",
				tabIndex: -1,
				...
				children: /* @__PURE__ */ jsx(TextStrikethroughIcon, { className: "size-3.5" })
			}),
			/* @__PURE__ */ jsx(Toggle$1, {
				size: isFullscreen ? "lg" : "sm",
				tabIndex: -1,
				...
				children: /* @__PURE__ */ jsx(HighlighterCircleIcon, { className: "size-3.5" })
			}),
			...
			/* @__PURE__ */ jsxs(DropdownMenu, { children: [/* @__PURE__ */ jsx(DropdownMenuTrigger, { render: /* @__PURE__ */ jsx(Button, {
				...
				variant: "ghost",
				className: "rounded-none",
				children: match(state).with({ isParagraph: true }, () => /* @__PURE__ */ jsx(ParagraphIcon, { className: "size-3.5" })).with({ isHeading1: true }, () => /* @__PURE__ */ jsx(TextHOneIcon, { className: "size-3.5" })).with({ isHeading2: true }, () => /* @__PURE__ */ jsx(TextHTwoIcon, { className: "size-3.5" })).with({ isHeading3: true }, () => /* @__PURE__ */ jsx(TextHThreeIcon, { className: "size-3.5" })).with({ isHeading4: true }, () => /* @__PURE__ */ jsx(TextHFourIcon, { className: "size-3.5" })).with({ isHeading5: true }, () => /* @__PURE__ */ jsx(TextHFiveIcon, { className: "size-3.5" })).with({ isHeading6: true }, () => /* @__PURE__ */ jsx(TextHSixIcon, { className: "size-3.5" })).otherwise(() => /* @__PURE__ */ jsx(ParagraphIcon, { className: "size-3.5" }))
				...
				/* @__PURE__ */ jsx(DropdownMenuCheckboxItem, {
					...
					children: /* @__PURE__ */ jsx(Trans, { id: "bkQRMh" })
				}),
			...
			/* @__PURE__ */ jsxs(DropdownMenu, { children: [/* @__PURE__ */ jsx(DropdownMenuTrigger, { render: /* @__PURE__ */ jsx(Button, {
				...
				variant: "ghost",
				className: "rounded-none",
				children: match(state).with({ isLeftAlign: true }, () => /* @__PURE__ */ jsx(TextAlignLeftIcon, { className: "size-3.5" })).with({ isCenterAlign: true }, () => /* @__PURE__ */ jsx(TextAlignCenterIcon, { className: "size-3.5" })).with({ isRightAlign: true }, () => /* @__PURE__ */ jsx(TextAlignRightIcon, { className: "size-3.5" })).with({ isJustifyAlign: true }, () => /* @__PURE__ */ jsx(TextAlignJustifyIcon, { className: "size-3.5" })).otherwise(() => /* @__PURE__ */ jsx(TextAlignLeftIcon, { className: "size-3.5" }))
			}) }), /* @__PURE__ */ jsxs(DropdownMenuContent, { children: [
				/* @__PURE__ */ jsx(DropdownMenuCheckboxItem, {
					disabled: !state.canLeftAlign,
					checked: state.isLeftAlign,
					onCheckedChange: state.toggleLeftAlign,
					children: /* @__PURE__ */ jsx(Trans, { id: "NQxKCQ" })
				}),
				/* @__PURE__ */ jsx(DropdownMenuCheckboxItem, {
					disabled: !state.canCenterAlign,
					checked: state.isCenterAlign,
					onCheckedChange: state.toggleCenterAlign,
					children: /* @__PURE__ */ jsx(Trans, { id: "QQWIWG" })
				}),
				/* @__PURE__ */ jsx(DropdownMenuCheckboxItem, {
					disabled: !state.canRightAlign,
					checked: state.isRightAlign,
					onCheckedChange: state.toggleRightAlign,
					children: /* @__PURE__ */ jsx(Trans, { id: "xV4gjr" })
				}),
				/* @__PURE__ */ jsx(DropdownMenuCheckboxItem, {
					disabled: !state.canJustifyAlign,
					checked: state.isJustifyAlign,
					onCheckedChange: state.toggleJustifyAlign,
					children: /* @__PURE__ */ jsx(Trans, { id: "QscRsp" })
				})
			] })] }),
			/* @__PURE__ */ jsx("div", { className: "mx-1 h-5 w-px bg-border" }),
			/* @__PURE__ */ jsx(Toggle$1, {
				...
				children: /* @__PURE__ */ jsx(ListBulletsIcon, { className: "size-3.5" })
			}),
			/* @__PURE__ */ jsx(Toggle$1, {
				size: isFullscreen ? "lg" : "sm",
				tabIndex: -1,
				...
				children: /* @__PURE__ */ jsx(ListNumbersIcon, { className: "size-3.5" })
			}),
			/* @__PURE__ */ jsx(Button, {
				size: isFullscreen ? "lg" : "sm",
				tabIndex: -1,
				...
				children: /* @__PURE__ */ jsx(TextOutdentIcon, { className: "size-3.5" })
			}),
			/* @__PURE__ */ jsx(Button, {
				size: isFullscreen ? "lg" : "sm",
				tabIndex: -1,
				...
				children: /* @__PURE__ */ jsx(TextIndentIcon, { className: "size-3.5" })
			}),
			/* @__PURE__ */ jsx("div", { className: "mx-1 h-5 w-px bg-border" }),
			state.isLink ? /* @__PURE__ */ jsx(Button, {
				size: isFullscreen ? "lg" : "sm",
				tabIndex: -1,
				variant: "ghost",
				className: "rounded-none",
				onClick: state.unsetLink,
				children: /* @__PURE__ */ jsx(LinkBreakIcon, { className: "size-3.5" })
			}) : /* @__PURE__ */ jsx(Button, {
				size: isFullscreen ? "lg" : "sm",
				tabIndex: -1,
				variant: "ghost",
			...
			/* @__PURE__ */ jsx(Toggle$1, {
				...
				children: /* @__PURE__ */ jsx(CodeSimpleIcon, { className: "size-3.5" })
			}),
			/* @__PURE__ */ jsx(Toggle$1, {
				size: isFullscreen ? "lg" : "sm",
				tabIndex: -1,
				...
				children: /* @__PURE__ */ jsx(CodeBlockIcon, { className: "size-3.5" })
			}),
			/* @__PURE__ */ jsxs(DropdownMenu, { children: [/* @__PURE__ */ jsx(DropdownMenuTrigger, { render: /* @__PURE__ */ jsx(Button, {
				size: isFullscreen ? "lg" : "sm",
				tabIndex: -1,
				...
				/* @__PURE__ */ jsxs(DropdownMenuItem, {
					...
					children: [/* @__PURE__ */ jsx(PlusIcon, {}), /* @__PURE__ */ jsx(Trans, { id: "qH7MLH" })]
				}),
				/* @__PURE__ */ jsx(DropdownMenuSeparator, {}),
				/* @__PURE__ */ jsxs(DropdownMenuItem, {
					disabled: !state.canAddColumnBefore,
					onClick: state.addColumnBefore,
					children: [/* @__PURE__ */ jsx(ColumnsPlusLeftIcon, {}), /* @__PURE__ */ jsx(Trans, { id: "F5uDfu" })]
				}),
				/* @__PURE__ */ jsxs(DropdownMenuItem, {
					disabled: !state.canAddColumnAfter,
					onClick: state.addColumnAfter,
					children: [/* @__PURE__ */ jsx(ColumnsPlusRightIcon, {}), /* @__PURE__ */ jsx(Trans, { id: "F3rB0I" })]
				}),
				/* @__PURE__ */ jsx(DropdownMenuSeparator, {}),
				/* @__PURE__ */ jsxs(DropdownMenuItem, {
					disabled: !state.canAddRowBefore,
					onClick: state.addRowBefore,
					children: [/* @__PURE__ */ jsx(RowsPlusTopIcon, {}), /* @__PURE__ */ jsx(Trans, { id: "AONP5V" })]
				}),
				/* @__PURE__ */ jsxs(DropdownMenuItem, {
					disabled: !state.canAddRowAfter,
					onClick: state.addRowAfter,
					children: [/* @__PURE__ */ jsx(RowsPlusBottomIcon, {}), /* @__PURE__ */ jsx(Trans, { id: "hEyqeR" })]
				}),
				/* @__PURE__ */ jsx(DropdownMenuSeparator, {}),
				/* @__PURE__ */ jsxs(DropdownMenuItem, {
					disabled: !state.canDeleteColumn,
					onClick: state.deleteColumn,
					children: [/* @__PURE__ */ jsx(TrashSimpleIcon, {}), /* @__PURE__ */ jsx(Trans, { id: "EhADgB" })]
				}),
				/* @__PURE__ */ jsxs(DropdownMenuItem, {
					disabled: !state.canDeleteRow,
					onClick: state.deleteRow,
					children: [/* @__PURE__ */ jsx(TrashSimpleIcon, {}), /* @__PURE__ */ jsx(Trans, { id: "f2AJjl" })]
				}),
				/* @__PURE__ */ jsx(DropdownMenuSeparator, {}),
				/* @__PURE__ */ jsxs(DropdownMenuItem, {
					variant: "destructive",
					...
					children: [/* @__PURE__ */ jsx(TrashSimpleIcon, {}), /* @__PURE__ */ jsx(Trans, { id: "WG8Qgt" })]
				})
			] })] }),
			/* @__PURE__ */ jsx(Button, {
				size: isFullscreen ? "lg" : "sm",
				...
				children: /* @__PURE__ */ jsx(KeyReturnIcon, { className: "size-3.5" })
			}),
			/* @__PURE__ */ jsx(Button, {
				size: isFullscreen ? "lg" : "sm",
				tabIndex: -1,
...
function TiptapContent({ content, className, ...props }) {
	return /* @__PURE__ */ jsx("div", {
		dangerouslySetInnerHTML: { __html: useMemo(() => sanitizeHtml(content), [content]) },
		className: cn(rich_input_module_default.tiptap_content, className),
		...props
	});
}
//#endregion
//#region src/components/resume/store/resume.ts
...
//#endregion
export { PromptDialogProvider as a, DialogContent as c, DialogHeader as d, DialogTitle as f, TiptapContent as i, DialogDescription as l, useTemporalStore as n, usePrompt as o, RichInput as r, Dialog$1 as s, useResumeStore as t, DialogFooter as u };
