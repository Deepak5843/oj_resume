import { _ as requestHandler, a as runWithStartContext, c as FrameType, d as TSS_SERVER_FUNCTION, f as X_TSS_RAW_RESPONSE, g as getResponse, i as flattenMiddlewares, l as TSS_CONTENT_TYPE_FRAMED_VERSIONED, n as getDefaultSerovalPlugins, o as createNullProtoObject, p as X_TSS_SERIALIZED, s as safeObjectMerge, t as mergeHeaders, u as TSS_FORMDATA_CONTEXT } from "./assets/esm-m5_tZiEi.js";
import { t as getServerFnById } from "./assets/__tanstack-start-server-fn-resolver-BcLDBzBo.js";
import "react";
import { RouterProvider } from "@tanstack/react-router";
import { jsx } from "react/jsx-runtime";
import { defineHandlerCallback, renderRouterToStream } from "@tanstack/react-router/ssr/server";
import { createRawStreamRPCPlugin, createSerializationAdapter, executeRewriteInput, isNotFound, isRedirect, isResolvedRedirect, rootRouteId } from "@tanstack/router-core";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DbVGerim.js");
...
async function loadEntries() {
	const routerEntry = await import("./assets/router-BwRTkAUd.js");
	return {
		startEntry: await import("./assets/start-axwMiPe6.js"),
		routerEntry
	};
}
function getEntries() {
