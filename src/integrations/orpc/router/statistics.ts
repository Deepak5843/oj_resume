...
const userRouter = {
	getCount: publicProcedure
		.route({
			...
			description:
				"Returns the total number of registered users on this 1Digit Resume instance. The count is cached for up to 6 hours for performance. No authentication required.",
...
const resumeRouter = {
	getCount: publicProcedure
		.route({
			...
			description:
				"Returns the total number of resumes created on this 1Digit Resume instance. The count is cached for up to 6 hours for performance. No authentication required.",
